...
exports.topUpMoney = (0, shared_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    (0, shared_1.sendResponse)(res, {
        ...
        data: yield service.topUpMoney(req.body, req.user),
    });
}));
...
exports.cashIn = (0, shared_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    (0, shared_1.sendResponse)(res, {
        success: true,
        status: shared_1.HTTP_CODE.OK,
        message: 'Cash In Successful',
        data: yield service.cashIn(req.body, req.user),
    });
}));
exports.cashOut = (0, shared_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    (0, shared_1.sendResponse)(res, {
        success: true,
        status: shared_1.HTTP_CODE.OK,
        message: 'Cash Out Successful',
        data: yield service.cashOut(req.body, req.user),
    });
}));
