...
router.get('/get-all-users', (0, middlewares_1.checkAuth)(user_interface_1.Role.ADMIN, user_interface_1.Role.SUPER_ADMIN), controller.getAllUsers);
...
router.get('/request-for-agent', (0, middlewares_1.checkAuth)(user_interface_1.Role.USER), controller.requestForAgent);
router.patch('/update-to-agent-status', (0, middlewares_1.checkAuth)(user_interface_1.Role.ADMIN, user_interface_1.Role.SUPER_ADMIN), (0, middlewares_1.validateRequest)(validator.zUpdateToAgentSchema), controller.updateToAgentStatus);
