...
const envSchema = zod_1.z.object({
    ...
    JWT_USER_VERIFY_SECRET: zod_1.z
        .string()
        .nonempty('JWT_USER_VERIFY_SECRET is required'),
    JWT_RESET_PASSWORD_SECRET: zod_1.z
        .string()
    ...
    /* CLOUDINARY SECRET */
    CLOUDINARY_CLAUDE_NAME: zod_1.z
        .string()
        .nonempty('CLOUDINARY_CLAUDE_NAME is required'),
    CLOUDINARY_API_KEY: zod_1.z.string().nonempty('CLOUDINARY_API_KEY is required'),
